...
<section class="bg-gradient-to-br from-primary-50 to-blue-50 section-padding">
    <div class="container-custom text-center">
        ...
        <p class="text-body max-w-3xl mx-auto mb-8">
            Ready to transform your school with EduVault Pro? Contact our team for a personalized demo, pricing information, or any questions about our comprehensive school management solution.
        </p>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <form class="space-y-6" method="POST" action="{{ route('contact') }}">
                    ...
                    <div>
                        <label for="school_name" class="block text-sm font-medium text-gray-700 mb-2">School/Organization Name</label>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <label for="consent" class="text-sm text-gray-600">
                            I agree to receive communications from EduVault Pro and understand that I can unsubscribe at any time. *
                        </label>
                    </div>
            ...
            <div>
                ...
                <p class="text-body mb-8">
                    Connect with us through multiple channels. We're here to support your educational institution's digital transformation journey.
                </p>
    ...
    <div class="container-custom">
        <div class="text-center mb-16">
            ...
            <p class="text-body max-w-3xl mx-auto">
                Find answers to common questions about EduVault Pro. Can't find what you're looking for? Contact us directly.
            </p>
        </div>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    <button @click="openFaq = openFaq === 1 ? null : 1" 
                        ...
                        <div class="flex justify-between items-center">
                            <h3 class="font-semibold text-gray-900">How long does it take to implement EduVault Pro?</h3>
                    ...
                    <div x-show="openFaq === 1" x-transition:enter="transition ease-out duration-200" 
                         ...
                         class="px-6 pb-4">
                        <p class="text-gray-600">Implementation typically takes 2-4 weeks depending on your school size and data migration requirements. Our team provides complete setup, data migration, and training services.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div x-show="openFaq === 2" x-transition:enter="transition ease-out duration-200" 
                         ...
                         x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                         class="px-6 pb-4">
                        <p class="text-gray-600">No, there's no limit on students, teachers, or classes. EduVault Pro scales with your institution. Our pricing is based on the overall package, not per user.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div x-show="openFaq === 3" x-transition:enter="transition ease-out duration-200" 
                         ...
                         x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                         class="px-6 pb-4">
                        <p class="text-gray-600">We provide comprehensive support including initial training, ongoing technical support, regular updates, and dedicated customer success management. Support is available via email, phone, and live chat.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div x-show="openFaq === 4" x-transition:enter="transition ease-out duration-200" 
                         ...
                         x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                         class="px-6 pb-4">
                        <p class="text-gray-600">Yes, we provide comprehensive data migration services. Our team can help migrate student records, academic data, fee information, and other critical data from your existing system to EduVault Pro.</p>
                    </div>
                </div>
            </div>
        </div>
