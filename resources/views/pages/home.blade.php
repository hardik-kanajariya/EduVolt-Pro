        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-center lg:text-left">
                ...
                <p class="text-body mb-8 animate-slide-up">
                    Streamline your school operations with EduVault Pro - a comprehensive management system designed for modern educational institutions. Manage students, teachers, attendance, fees, library, and more with our advanced platform.
                </p>
                ...
                <div class="mt-8 pt-8 border-t border-gray-200">
                    ...
                    <div class="flex items-center justify-center lg:justify-start space-x-6 opacity-60">
                        ...
                        <span class="text-gray-400 font-medium">Filament v4</span>
            ...
            <div class="relative">
                ...
                <!-- Floating Elements -->
                <div class="absolute -top-4 -right-4 w-20 h-20 bg-yellow-200 rounded-full opacity-60 animate-bounce-slow"></div>
                <div class="absolute -bottom-4 -left-4 w-16 h-16 bg-blue-200 rounded-full opacity-60 animate-bounce-slow" style="animation-delay: 1s;"></div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-custom">
        <div class="text-center mb-16">
            ...
            <p class="text-body max-w-3xl mx-auto">
                EduVault Pro provides a complete suite of tools to streamline every aspect of your educational institution, from student enrollment to graduation.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-6">
                    <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m3 4.197a4 4 0 11-3-6.943 4 4 0 013 6.943z"></path>
                    </svg>
                </div>
                <h3 class="heading-3 mb-4">Student Management</h3>
                <p class="text-gray-600 leading-relaxed">
                    Comprehensive student profiles, enrollment tracking, academic progress monitoring, and parent communication tools.
                </p>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                ...
                <p class="text-gray-600 leading-relaxed">
                    Real-time attendance marking, automated reports, parent notifications, and detailed analytics for better monitoring.
                </p>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                ...
                <p class="text-gray-600 leading-relaxed">
                    Complete fee structure management, payment tracking, receipt generation, and financial reporting system.
                </p>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                ...
                <p class="text-gray-600 leading-relaxed">
                    Digital library management with book cataloging, issue tracking, fine management, and reading analytics.
                </p>
            </div>
...
<section class="section-padding bg-gray-50">
    <div class="container-custom">
        <div class="text-center mb-16">
            ...
            <p class="text-body max-w-3xl mx-auto">
                EduVault Pro provides specialized dashboards for different user roles, ensuring everyone has access to the tools they need.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
                ...
                <p class="text-gray-600 mb-6">Complete system control with user management, system settings, and comprehensive reports.</p>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
                ...
                <p class="text-gray-600 mb-6">Teacher-focused interface for class management, attendance, and assignment handling.</p>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
                ...
                <p class="text-gray-600 mb-6">Student dashboard with grades, assignments, attendance, and academic progress.</p>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
                ...
                <p class="text-gray-600 mb-6">Parent access to monitor child's progress, attendance, fees, and school communication.</p>
...
<section class="section-padding bg-primary-600 text-white">
    <div class="container-custom text-center">
        ...
        <p class="text-xl text-primary-100 mb-8 max-w-3xl mx-auto">
            Join hundreds of educational institutions already using EduVault Pro to streamline their operations and improve educational outcomes.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('contact') }}" class="bg-white text-primary-600 hover:bg-gray-100 font-medium py-3 px-8 rounded-lg transition-colors duration-200 text-lg">
                Start Free Trial
            </a>
            <a href="{{ route('pricing') }}" class="border-2 border-white text-white hover:bg-white hover:text-primary-600 font-medium py-3 px-8 rounded-lg transition-colors duration-200 text-lg">
                View Pricing
            </a>
        </div>
