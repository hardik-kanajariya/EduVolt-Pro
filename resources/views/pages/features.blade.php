            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-body mb-8">
                        Comprehensive student information system with complete profile management, enrollment tracking, and
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Detailed student information including personal details, academic
                                    history, medical records, and emergency contacts.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Streamlined admission process with online applications, document
                                    management, and automated enrollment workflows.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Integrated parent portal with real-time updates, messaging system,
                                    and progress tracking for better engagement.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-custom">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="order-1 lg:order-2">
                    ...
                    <p class="text-body mb-8">
                        Efficient attendance management with real-time tracking, automated reports, and instant parent
                        notifications for better student monitoring.
                    </p>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Mark attendance with one click and get instant updates across all
                                    platforms including parent portals.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Generate comprehensive attendance reports with detailed analytics
                                    and insights for better decision making.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Automatic email and SMS notifications to parents when students are
                                    absent or late.</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-custom">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                    ...
                    <p class="text-gray-600 mb-4">Create and manage class schedules with conflict detection and automatic
                        teacher allocation.</p>
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                    ...
                    <p class="text-gray-600 mb-4">Digital assignment distribution and submission with automated grading
                        capabilities.</p>
                    <ul class="text-sm text-gray-600 space-y-1">
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                    ...
                    <p class="text-gray-600 mb-4">Comprehensive exam scheduling and result management with automated report
                        generation.</p>
                    <ul class="text-sm text-gray-600 space-y-1">
    ...
    <section id="financial-management" class="section-padding bg-gray-50">
        <div class="container-custom">
            <div class="text-center mb-16">
                ...
                <p class="text-body max-w-3xl mx-auto">
                    Comprehensive fee management system with automated calculations, receipt generation, and detailed
                    financial reporting.
                </p>
            </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Configure flexible fee structures with support for installments,
                                    discounts, and scholarships.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Generate professional receipts automatically with school branding
                                    and detailed payment information.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Comprehensive financial reporting with income statements, defaulter
                                    lists, and collection analysis.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Allow parents to view fee status, payment history, and receive
        ...
        <div class="container-custom text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{{ route('pricing') }}"
                    class="border-2 border-white text-white hover:bg-white hover:text-primary-600 font-medium py-3 px-8 rounded-lg transition-colors duration-200">
                    View Pricing
                </a>
            </div>
        </div>
