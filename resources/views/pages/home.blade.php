...
@section('description', 'EduVault Pro - Complete school management system for ₹40,000 one-time purchase. Lifetime access to student management, attendance tracking, fee management, library system with Laravel & Filament. No recurring fees.')
...
@section('content')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p class="text-body mb-8 animate-slide-up">
                        Transform your educational institution with EduVault Pro - a comprehensive, one-time purchase school
                        management system.
                        Built with Laravel & Filament, offering lifetime access to all features including student
                        management, attendance tracking,
                        fee management, library system, and multi-panel interfaces for admins, teachers, students, and
                        parents.
                    </p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-gray-700 font-medium">Complete Data Control</span>
                        </div>
                    </div>
    ...
    <section class="section-padding bg-gray-50">
        <div class="container-custom">
            <div class="text-center mb-16">
                <h2 class="heading-2 mb-6">
                    Simple, <span class="text-primary-600">One-Time</span> Pricing
                </h2>
                <p class="text-body max-w-3xl mx-auto">
                    No monthly fees, no hidden costs. Pay once and own EduVault Pro forever with lifetime access to all
                    features.
                </p>
            </div>
            ...
            <div class="max-w-2xl mx-auto">
                <div
                    class="bg-gradient-to-br from-primary-50 to-blue-50 rounded-3xl p-8 md:p-12 border-4 border-primary-200 relative overflow-hidden">
                    <!-- Popular Badge -->
                    <div class="absolute -top-3 left-1/2 transform -translate-x-1/2">
                        <span
                            class="bg-gradient-to-r from-primary-600 to-blue-600 text-white px-8 py-2 rounded-full text-sm font-semibold shadow-lg">
                            ⭐ One-Time Purchase
                        </span>
                    </div>

                    <div class="text-center mt-8">
                        <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-4">EduVault Pro</h3>
                        <p class="text-lg text-gray-600 mb-6">Complete School Management System</p>

                        <!-- Price Display -->
                        <div class="mb-8">
                            <div class="flex items-center justify-center space-x-2 mb-4">
                                <span class="text-4xl md:text-5xl font-bold text-primary-600">₹40,000</span>
                            </div>
                            <div class="text-lg text-gray-600 mb-2">One-time payment • Lifetime access</div>
                            <div
                                class="inline-flex items-center bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium">
                                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                        clip-rule="evenodd"></path>
                                </svg>
                                No Recurring Fees • Free Updates Forever
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-gray-700">Multi-Panel Interface</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                ...
                                <span class="text-gray-700">Complete Data Ownership</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                ...
                                <span class="text-gray-700">Technical Support Included</span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <a href="{{ route('contact') }}" class="btn-primary text-lg px-8 py-4 inline-block">
                                Get EduVault Pro Today
                            </a>
                            <p class="text-sm text-gray-600">
                                Installation assistance and training included
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="section-padding bg-primary-600 text-white">
        <div class="container-custom text-center">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold font-heading mb-6">
                Ready to Own Your School Management System?
            </h2>
            <p class="text-xl text-primary-100 mb-8 max-w-3xl mx-auto">
                Join forward-thinking schools that have invested in EduVault Pro for long-term success.
                One payment, lifetime ownership, complete control.
            </p>
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div class="text-center">
                    ...
                    <div class="text-primary-200">Ownership</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold mb-2">₹0</div>
                    <div class="text-primary-200">Monthly Fees</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold mb-2">∞</div>
                    <div class="text-primary-200">Lifetime Access</div>
                </div>
            </div>
        </div>
    </section>
