...
return new class extends Migration
{
    ...
    public function down(): void
    {
        Schema::table('student_progress', function (Blueprint $table) {
            ...
            // Drop columns
            $table->dropColumn([
                'academic_year_id', 'class_id', 'gpa',
                'total_assignments', 'submitted_assignments', 'late_submissions',
                'total_exams', 'exams_taken', 'exams_passed',
                'total_classes', 'classes_attended', 'classes_absent', 'classes_late',
                'previous_grade', 'grade_change', 'behavioral_score',
                'achievements', 'areas_of_concern', 'effort_level', 'participation_level',
                'last_updated_at', 'updated_by', 'reporting_period_start', 'reporting_period_end'
            ]);
        });
    }
};
